...
<body>
    ...
    <div class="container">
        <div class="left-content">
            <div class="logo">
                <img width="24" height="24" src="https://img.icons8.com/material-rounded/24/star--v1.png"
                    alt="star--v1" />LOGO
            </div>
            ...
            <div class="main-content">
                ...
                <div class="main-paragraph">
                    <p>We’ll help you improve your professional profile, track your progress, and find the courses that
                        match your aspirations. Come and join us, you won’t regret it.</p>
                </div>
        ...
        <div class="right-content">
            <form method="post" action="adminloginpro.php">
